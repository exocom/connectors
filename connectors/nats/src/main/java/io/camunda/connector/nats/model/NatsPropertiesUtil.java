...
import org.apache.nats.clients.CommonClientConfigs;
import org.apache.nats.clients.consumer.ConsumerConfig;
import org.apache.nats.clients.producer.ProducerConfig;
import org.apache.nats.common.config.SaslConfigs;

import java.util.Properties;

public final class NatsPropertiesUtil {
  ...
  private static final String SASL_JAAS_CONFIG_VALUE =
      "org.apache.nats.common.security.plain.PlainLoginModule   required username='%s'   password='%s';";
  ...
  private NatsPropertiesUtil() {}

  private static final String STRING_SERIALIZER =
      "org.apache.nats.common.serialization.StringSerializer";
  private static final String BYTE_ARRAY_SERIALIZER =
      "org.apache.nats.common.serialization.ByteArraySerializer";

  // NATS client is built using java.utils.Properties.
  // This method creates properties required to establish connection and produce messages.
  public static Properties assembleNatsClientProperties(NatsConnectorRequest request) {
    Properties props = new Properties();

    // Step 1: collect properties directly from the form
    if (request.authentication() != null) {
      Properties authProps =
          NatsPropertiesUtil.produceAuthenticationProperties(request.authentication());
    ...
    // See the list of possible values at org.apache.nats.clients.producer.ProducerConfig
  ...
  public static Properties produceAuthenticationProperties(NatsAuthentication authentication) {
